...
num_videos = 20 #total, including test set
num_frames = 20
threshold = 0.0
...
n_top = 5
params = Video_Params(n_possible_objects = length(office_subset), sigma = 200.)
...
# 	objects_observed, camera_trajectories, params, lesioned_V_file, lesioned_ws_file, order)
