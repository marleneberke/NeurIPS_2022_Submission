...
#This one takes observations from the NN and keeps the labels the NN output.
function make_observations(dict::Array{Any,1}, receptive_fields::Vector{Receptive_Field}, num_videos::Int64, num_frames::Int64, threshold=0.0, top_n=Inf)
...
#This translates labels where the index corresponds to the COCO id to labels where the index
#corresponds to the office_subset
